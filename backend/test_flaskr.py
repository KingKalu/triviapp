...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}{}/{}".format('postgres:LoveChristMore','@localhost:5432', self.database_name)
    ...
    def test_404_sent_requesting_questions_beyond_valid_page(self):
        res = self.client().get('/questions?page=8888')
        data = json.loads(res.data)
    ...
    def test_404_sent_requesting_non_existing_category(self):
        res = self.client().get('/categories/111111')
        data = json.loads(res.data)
    ...
    def test_search_questions(self):
        ...
        self.assertIsNotNone(data['all_questions'])
